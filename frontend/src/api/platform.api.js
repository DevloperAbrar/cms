...
export const updateCollege      = (id, data)   => api.patch(`/colleges/${id}`, data).then(d);
...
export const regeneratePassword = (id, data)   => api.patch(`/colleges/${id}/regenerate-password`, data).then(d);
